...
All engineering operations are based on the current camera view, including the arm, end-effector, and chassis movement. Press F5 twice to switch to third-person view, then move the mouse to adjust the camera and thereby reposition and reorient the Ores in 3-D space.
LMB                            Shot
RMB                           Enable auto-aim
